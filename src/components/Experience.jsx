      ...
      roles: [
        {
          ...
          highlights: [
            {
              title: 'Conversion',
              description: 'Led a team of 5 engineers to build a scalable internal transfer system that reduced average associate conversion time from 30 min to 90s. A 95% reduction, saving 2000+ business hours per year. This was an asynchronous lambda-based solution processing 5K conversions per request reducing manual ToT (time-on-task) by 78%.'
            },
            {
              title: 'Self Service UI',
              description: 'Automated the process of expanding the transfer product to a new business and associate population. Saving an average of 6 weeks per expansion for an average of 24 weeks per year in development time.'
            },
            {
            ...
            },
            {
              ...
              description: 'Integrated with an internal system to create a two way data sharing system consisting of async state machines and synchronous APIs backed by API gateway scaling to 120+ burst TPS. The system served both business and associates, saving 1500+ of business hours per year by eliminating manual planning work and providing heatmaps to associates resulting in more informed transfer decisions.'
            }
          ]
        },
        {
          ...
          achievements: [
            ...
            'Reduced TTI (time-to-interaction) by 52% via critical feature decoupling and optimizing AppSync queries.',
        ...
        },
        {
          ...
          achievements: [
            'Built a custom load testing framework with built-in production safety. This reduced testing time from 16 hrs to 1 hr',
      ...
      roles: [
        {
          ...
          description: 'Designed, built and scaled a critical eligibility service responsible for calculating eligibility for each user. The service handled 50 TPS and 200K+ daily requests. It allowed complex rules to be created and existing rules to be updated by business without dev intervention.'
        }
      ]
    },
    {
      ...
      roles: [
        {
          ...
          description: 'Worked on their flagship product TrialRun. Re-architecturing API level code using Celery, RabbitMQ and Redis caching to handle a 95x increase in size for user request.'
        }
      ]
    },
    {
